...
tellraw @s ["",{"text":"To disable Bert entirely, go to","color":"red"},{"text":" ","color":"dark_red"},{"text":"Henri's settings","color":"blue","clickEvent":{"action":"run_command","value":"/function henri:settings"}},{"text":" and disable Bert.","color":"red"}]

tellraw @s ["",{"text":"Allow multiple Berts to walk around in one game.","italic":true,"color":"aqua"}]
...
tellraw @s ["",{"text":"Let Bert travel around the worlds to drop by various players, even when they're distanced far from each other.","italic":true,"color":"aqua"}]
